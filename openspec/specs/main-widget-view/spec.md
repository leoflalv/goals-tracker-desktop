# Main Widget View Spec

## Purpose

The always-visible main widget — a scrollable habit list with color-coded completion checkboxes, week dots, streak counters, a daily progress bar, drag handle, and the gear icon that opens the Manage Window.
