...
React hooks that orchestrate habit and completion data fetching/mutations via TanStack Query, the pure streak/week-dot/daily-progress derivation functions, and the cross-window sync listener for the `habits:changed` event.
